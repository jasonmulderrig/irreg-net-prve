...
def filepath_str(network: str) -> str:
    ...
    with periodic irregular spatial networks exists as a directory, and
    then returns the baseline filepath. The filepath must match the
    directory structure of the local computer. For Windows machines, the
    backslash must be represented as a double backslash. For Linux/Mac
    machines, the forwardslash can be directly represented as a
    forwardslash.
    ...
    """
    # For MacOS
    # filepath = f"/Users/jasonmulderrig/research/projects/irreg-net-prve/{network}/"
    # For Windows OS
    filepath = f"C:\\Users\\mulderjp\\projects\\irreg-net-prve\\{network}\\"
    # For Linux
    # filepath = f"/p/home/jpm2225/projects/irreg-net-prve/{network}/"
