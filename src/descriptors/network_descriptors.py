...
import src.descriptors.nodal_degree_topological_descriptors
...
def network_global_morphological_descriptor(
    ...
    if hasattr(src.descriptors.morphological_descriptors, mrphlgcl_dscrptr_func_str):
        mrphlgcl_dscrptr_func = getattr(
            src.descriptors.morphological_descriptors, mrphlgcl_dscrptr_func_str)
    else:
        error_str = (
