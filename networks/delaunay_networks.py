...
def delaunay_network_local_topological_descriptor(
    ...
    if eeel_ntwrk == True:
        result_filename = (
            delaunay_filename + "-eeel-lcl-" + tplgcl_dscrptr + ".dat"
        )
    else:
...
def delaunay_network_global_topological_descriptor(
    ...
    if eeel_ntwrk == True:
        if np_oprtn == "":
            result_filename = (
                delaunay_filename + "-eeel-glbl-" + tplgcl_dscrptr + ".dat"
            )
        else:
            result_filename = (
                delaunay_filename + "-eeel-glbl-" + np_oprtn + "-"
                + tplgcl_dscrptr + ".dat"
            )
    else:
        if np_oprtn == "":
            result_filename = (
                delaunay_filename + "-glbl-" + tplgcl_dscrptr + ".dat"
            )
        else:
            result_filename = (
