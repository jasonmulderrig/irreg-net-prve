...
def voronoi_network_local_topological_descriptor(
    ...
    if eeel_ntwrk == True:
        result_filename = (
            voronoi_filename + "-eeel-lcl-" + tplgcl_dscrptr + ".dat"
        )
    else:
...
def voronoi_network_global_topological_descriptor(
    ...
    if eeel_ntwrk == True:
        if np_oprtn == "":
            result_filename = (
                voronoi_filename + "-eeel-glbl-" + tplgcl_dscrptr + ".dat"
            )
        else:
            result_filename = (
                voronoi_filename + "-eeel-glbl-" + np_oprtn + "-"
                + tplgcl_dscrptr + ".dat"
            )
    else:
        if np_oprtn == "":
            result_filename = (
                voronoi_filename + "-glbl-" + tplgcl_dscrptr + ".dat"
            )
        else:
            result_filename = (
