...
from descriptors.nodal_degree_topological_descriptors import k_func
...
def swidt_network_edge_pruning_procedure(
    ...
    if np.any(conn_graph_k > k):
        ...
        # Dangling nodes are of type 0, all other nodes are already of
        # type 1.
        for indx in range(mx_cmp_pruned_conn_n):
            ...
            if core_node_k == 1:
                mx_cmp_pruned_conn_graph.nodes[core_node]["type"] = 0
