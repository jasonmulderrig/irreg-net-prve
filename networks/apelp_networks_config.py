...
def params_arr_func(cfg: apelpConfig) -> tuple[np.ndarray, int]:
...
def sample_params_arr_func(cfg: apelpConfig) -> tuple[np.ndarray, int]:
    dim_arr = np.asarray(cfg.topology.dim, dtype=int)
    b_arr = np.asarray(cfg.topology.b)
    xi_arr = np.asarray(cfg.topology.xi)
    rho_en_arr = np.asarray(cfg.topology.rho_en)
...
def sample_config_params_arr_func(cfg: apelpConfig) -> tuple[np.ndarray, int]:
    dim_arr = np.asarray(cfg.topology.dim, dtype=int)
    b_arr = np.asarray(cfg.topology.b)
    xi_arr = np.asarray(cfg.topology.xi)
    rho_en_arr = np.asarray(cfg.topology.rho_en)
